                                                            ...
                                                            <form class="needs-validation" method="post" enctype="multipart/form-data" role="form">
                                                                <div class="row">
                                                                    <div class="form-group col-md-12">
                                                                        ...
                                                                        <input type="hidden" required name="login_rank" value="<?php echo $user['login_rank']; ?>" class="form-control">
                                                                ...
                                                                <div class="text-right">
                                                                    <button type="submit" name="Update_Staff" class="btn btn-outline-success">Save</button>
                                                                </div>
                                                            </form>
                                                            <!-- /.card-body -->
                                                        </div>
                                                        <div class="tab-pane fade" id="vert-tabs-profile" role="tabpanel" aria-labelledby="vert-tabs-profile-tab">
                                                            ...
                                                            <div class="card-body">
                                                                <form class="needs-validation" method="post" enctype="multipart/form-data" role="form">
                                                                    ...
                                                                    <div class="text-right">
                                                                        <button type="submit" name="Change_Password" class="btn btn-outline-success">Save</button>
                                                                    </div>
                                                                </form>
                                                            </div>
                                                        </div>
