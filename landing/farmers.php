        ...
        <div class="body-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="d-flex justify-content-between">
                    <div class="mr-auto">
                        <h2 class="text-black font-w600">Farmers</h2>
                        <p class="mb-0">Manage farmers details</p>
                    </div>
                    <div class="">
                        <button data-bs-toggle="modal" data-bs-target="#add_modal" type="button" class="btn btn-outline-secondary m-1">Register Farmer</button>
                    </div>
                </div>
                <!-- Add Admin Modal -->
                        ...
                        <div class="modal-content">
                            <div class="modal-header align-items-center">
                                <div class="modal-title">
                                    <h6 class="mb-0">Register Farmer</h6>
                                </div>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a data-bs-toggle="modal" href="#update_<?php echo $system_users['farmer_id']; ?>" class="badge bg-warning"><i class="ti ti-edit"></i> Edit</a>
                                                            <a data-bs-toggle="modal" href="#delete_<?php echo $system_users['farmer_id']; ?>" class="badge bg-danger"><i class="ti ti-trash"></i> Delete</a>
                                                        </td>
                                                    </tr>
                                            <?php
                                                    include('../app/modals/farmers.php');
                                                }
                                            } ?>
                                        </tbody>
                                    </table>
