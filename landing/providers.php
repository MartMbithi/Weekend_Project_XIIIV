        ...
        <div class="body-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="d-flex justify-content-between">
                    <div class="mr-auto">
                        <h2 class="text-black font-w600">Ploughing Service Providers</h2>
                        <p class="mb-0">Manage Ploughing Service Providers</p>
                    </div>
                    <div class="">
                        <button data-bs-toggle="modal" data-bs-target="#add_modal" type="button" class="btn btn-outline-secondary m-1">Register Service Provider</button>
                    </div>
                </div>
                <!-- Add Admin Modal -->
                        ...
                        <div class="modal-content">
                            <div class="modal-header align-items-center">
                                <div class="modal-title">
                                    <h6 class="mb-0">Register Service Provider</h6>
                                </div>
                            ...
                            <form method="post" enctype="multipart/form-data" role="form">
                                ...
                                <div class="modal-footer">
                                    <button type="submit" name="Add_Service_Provider" class="btn btn-primary">Save</button>
                                </div>
                            </form>
                        </div>
                    </div>
                                ...
                                <div class="table-responsive">
                                    <table class="data table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        <td><?php echo $system_users['service_provider_name']; ?></td>
                                                        <td><?php echo $system_users['login_email']; ?></td>
                                                        <td><?php echo $system_users['service_provider_contacts']; ?></td>
                                                        <td><?php echo $system_users['service_provider_address']; ?></td>
                                                        <td>
                                                            <a data-bs-toggle="modal" href="#update_<?php echo $system_users['service_provider_id']; ?>" class="badge bg-warning"><i class="ti ti-edit"></i> Edit</a>
                                                            <a data-bs-toggle="modal" href="#delete_<?php echo $system_users['service_provider_id']; ?>" class="badge bg-danger"><i class="ti ti-trash"></i> Delete</a>
                                                        </td>
                                                    </tr>
                                            <?php
                                                    include('../app/modals/providers.php');
                                                }
                                            } ?>
                                        </tbody>
                                    </table>
